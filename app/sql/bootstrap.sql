...
CREATE TABLE BBY_19_incident (ID int NOT NULL AUTO_INCREMENT, title varchar(200), priority varchar(50), type varchar(100), status varchar(50), callerID int, description varchar(1000), lat decimal(8,5), lon decimal(8,5), timestamp TIMESTAMP, PRIMARY KEY (ID));
...
REPLACE INTO BBY_19_incident (title, priority, type, status, callerID, description, lat, lon, timestamp) VALUES ('Test Incident', 'URGENT', 'HARASSMENT', 'ACTIVE', 2, 'Some description', 48.787386, -125.221652, CURRENT_TIMESTAMP);
